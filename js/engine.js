...
var Engine = (function(global) {
    ...
    doc.body.style.background ='url("images/normalbackground.jpg")';
    ...
    function render() {
         ...
         */
        var rowImages = [
                'images/wood-block.png',   // Top row is water
                'images/gray-block.png',   // Row 1 of 3 of stone
                'images/gray-block.png',   // Row 2 of 3 of stone
                'images/gray-block.png',   // Row 3 of 3 of stone
                'images/gray-block.png',   // Row 1 of 2 ozf grass
                'images/wood-block.png'    // Row 2 of 2 of grass
            ],
            numRows = 6,
            numCols = 5,
            row, col;
    ...
    Resources.load([
        ...
        'images/gray-block.png',
        'images/wood-block.png',
        'images/ghoste.png',
        'images/ghostex.png',
        'images/ghosth.png',
        'images/ghosteh-o.png',
